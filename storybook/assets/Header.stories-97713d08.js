...
`,O=r.div`
  ...
  align-items: center;
  height: 80px;
`;function U(){const{server:e,handleServer:a}=S(),i=v(h),o=c=>{const{value:s}=c.currentTarget,g=C.filter(u=>u===s)[0];a(g)};return d.useEffect(()=>{(async()=>{const s=await j(e);i(s)})()},[e,i]),t.jsx(z,{children:t.jsx(T,{children:t.jsxs(O,{children:[t.jsx(N,{}),t.jsx(k,{options:[{value:"마코",name:"마코"},{value:"우가",name:"우가"},{value:"허브",name:"허브"}],onChange:o}),t.jsx(d.Suspense,{children:t.jsx(D,{})})]})})})}const J={component:U,title:"Header"},n={args:{}};var m,l,p;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {}
...
//# sourceMappingURL=Header.stories-97713d08.js.map
